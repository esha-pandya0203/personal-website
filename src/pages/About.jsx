export default function About() {
    return (
        <div className='about rounded-container' id='about'>
            <div className='about-picture'>
                <img src={process.env.PUBLIC_URL + '/images/esha-picture.png'} className='profile-picture' alt='profile'/>
            </div>
            <div className='about-text'>
                <h2 className='about-heading'>About Me</h2>
                <p className='about-p'>I am a third-year Computer Science student at Northeastern University, pursuing a minor in Business Administration. I'm focused on improving my skills and knowledge in Java, C#, and Python through both academic and independent projects.
